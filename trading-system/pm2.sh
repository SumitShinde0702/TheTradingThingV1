...
print_header() {
    echo -e "${PURPLE}═══════════════════════════════════════${NC}"
    echo -e "${PURPLE}  🤖 LIA Trading Bot - PM2 Manager${NC}"
    echo -e "${PURPLE}═══════════════════════════════════════${NC}"
    echo ""
}
...
show_status() {
    ...
    echo ""
    print_info "详细信息:"
    pm2 info lia-backend
    echo ""
    pm2 info lia-frontend
}
...
show_logs() {
    if [ -z "$2" ]; then
        ...
        pm2 logs lia-backend
    elif [ "$2" = "frontend" ]; then
        pm2 logs lia-frontend
    else
